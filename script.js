...
function setupHoverAutoplay(videoElement) {
    ...
    container.addEventListener('mouseenter', function() {
        ...
        hoverTimer = setTimeout(() => {
            console.log('⏰ 5 MÁSODPERC LETELT - videó indítás próbálkozás');
            ...
            if (!userInteracted && !isVideoPlaying) {
                // KRITIKUS: Muted beállítás biztosítása autoplay-hez
                videoElement.muted = true;
                
                videoElement.play().then(() => {
                    isVideoPlaying = true;
                    console.log('✅ VIDEÓ SIKERESEN ELINDULT (hover autoplay)');
                    
                }).catch(error => {
                    console.log('❌ AUTOPLAY HIBA:', error.name, error.message);
                    console.log('Böngésző autoplay policy blokkolja');
                    
                    // Egyszerű visual feedback
    ...
    container.addEventListener('mouseleave', function() {
        ...
        if (!userInteracted && isVideoPlaying) {
            ...
            console.log('⏸️ Videó megállítva és visszatekerve');
        }
    });
