...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (path.includes('product.html') || path.startsWith('/termek/')) {
        ...
        } else if (['eter', 'argentum', 'zafir'].includes(path)) {
            // Old URL format: product.html?product=eter
            productId = path.substring(1);
        } else if (path.endsWith('/eter') || path.endsWith('/eter/')) {
            // Format: /energix/eter or /energix/eter/
            productId = 'eter';
            console.log('Product ID:', productId);
        } else if (path.endsWith('/argentum') || path.endsWith('/argentum/')) {
            // Format: /energix/argentum or /energix/argentum/
            productId = 'argentum';
        } else if (path.endsWith('/zafir') || path.endsWith('/zafir/')) {
            // Format: /energix/zafir or /energix/zafir/
            productId = 'zafir';
        } else {
...
function initProductPage(productId) {
    ...
    console.log('=== INIT PRODUCT PAGE CALLED ===', productId);
    console.trace('Trace of initProductPage call');
    ...
    if (descriptionElement) {
        console.log('Setting description text:', product.description);
    ...
    console.log('Found full description element:', fullDescriptionElement);

    if (fullDescriptionElement) {
        console.log('Setting full description HTML:', product.fullDescription);
