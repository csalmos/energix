...
function handleEmergencyImagePlacement(newImg, imageData) {
    console.log('🆘 Emergency image placement aktiválva');
    
    // Keresés prioritási sorrendben
    const possibleContainers = [
        document.querySelector('.product-hero'),
        document.querySelector('.product-images'),
        document.querySelector('.product-main-image')?.parentElement,
    ...
    if (container) {
        // Régi elem brutális eltávolítása
        const oldElement = document.getElementById('productImage');
        if (oldElement) {
            oldElement.remove();
            console.log('🗑️ Régi elem eltávolítva emergency módban');
        }
        ...
        console.log('✅ Emergency placement sikeres:', container.className);
        
        // Analytics - emergency event tracking
        if (typeof gtag !== 'undefined') {
            gtag('event', 'emergency_image_placement', {
                'container_type': container.tagName,
        ...
        console.error('🚨 Nincs elérhető container - kritikus hiba!');
        
        // Utolsó mentsvár: fixed overlay
        ...
        console.log('🆘 Fixed overlay emergency mode aktiválva');
    }
}
