...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const materialInfo = document.querySelector('.material-info'); // A szöveg konténer
    ...
    materialOptions.forEach(option => {
        option.addEventListener('click', function(e) {
            ...
            if (targetContent) {
                ...
                // MOBILOS AUTO-SCROLL FUNKCIÓ
                if (window.innerWidth <= 768 && materialInfo) {
                    // Kis késleltetés, hogy a content váltás megtörténjen
                    setTimeout(() => {
    ...
    if (materialTab) {
        materialTab.addEventListener('click', handleMaterialTabClick, true); // Use capture phase
    }
