...
function initProductPage(productId) {
    ...
    if (featureImage) {
        ...
        switch(productId) {
            case 'argentum':
                imagePath = 'assets/EnergiX/Argentum/Argentum, háttér nélkül-1000w.webp';
                altText = 'Argentum karkötő részletes nézet';
                break;
            case 'eter':
                imagePath = 'assets/EnergiX/Éter/Éter-háttérrel.avif';
                altText = 'Éter karkötő részletes nézet';
                break;
            case 'zafir':
                imagePath = 'assets/EnergiX/Zafír/Zafír_fehér_háttér.avif';
