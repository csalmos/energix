...
document.addEventListener('snipcart.ready', function() {
    // 1. ÁLTALÁNOS "MINDEN ESEMÉNY" FIGYELŐ (HIBÁK KERESÉSÉHEZ)
    Snipcart.events.on('*', (eventObject) => {
        console.log('Trigger (eventName):', eventName);
        console.log('SNIPCART EVENT FIRED:', eventObject.type, eventObject);
    });
    Snipcart.events.on('shipping.selected', function(shippingMethod) {
        ...
        if (shippingMethod && shippingMethod.description) {
            console.log('Description:', shippingMethod.description);
        }
        ...
        if (shippingMethod && 
            (shippingMethod.description && shippingMethod.description.includes('GLS Csomagautomata') ||
             shippingMethod.name && shippingMethod.name.includes('GLS Csomagautomata'))) {
