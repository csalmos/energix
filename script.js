...
function initProductPage(familyOrProductId, productId = null) {
    ...
    console.log('11. displayData.video:', displayData.video);
    console.log('12. displayData.video type:', typeof displayData.video);
    
    // KRITIKUS: Direkt property ellenőrzés
    console.log('13. displayData keys:', Object.keys(displayData));
    console.log('14. "video" in displayData:', 'video' in displayData);
    
    if (displayData.video) {
        console.log('✅ VIDEÓ MEGTALÁLVA!');
        console.log('Video object:', displayData.video);
        console.log('Video src:', displayData.video.src);
        console.log('Video poster:', displayData.video.poster);
        
        // Videó renderelés folytatása...
        renderVideoElement(displayData);
    } else {
        console.log('❌ displayData.video undefined vagy falsy');
        console.log('displayData.video === undefined:', displayData.video === undefined);
        console.log('displayData.video === null:', displayData.video === null);
        console.log('displayData.video === false:', displayData.video === false);
    }
