document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('Found feature dots:', featureDots.length);
    
    featureDots.forEach((dot, index) => {
        console.log(`Initializing dot ${index + 1}`);
        ...
        if (label) {
            ...
            console.log(`Dot ${index + 1} label:`, labelText);
    ...
    document.addEventListener('click', function handleDotClick(e) {
        ...
        console.log('Dot clicked:', {
            ...
            position: dot.getBoundingClientRect()
        });
    ...
    function showBottomSheet(content) {
        ...
        console.log('Showing bottom sheet with content:', content);
